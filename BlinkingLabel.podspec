...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/majeedyaseen/BlinkingLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'majeedyaseen' => 'majeed@trialx.com' }
  s.source           = { :git => 'https://github.com/majeedyaseen/BlinkingLabel.git', :tag => s.version.to_s }
